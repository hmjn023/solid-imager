...
CREATE TABLE "media_organization" (
	...
	"project_id" integer,
	"ip_id" integer,
	"status" "media_organization_status" DEFAULT 'active'
);
--> statement-breakpoint
...
ALTER TABLE "media_organization" ADD CONSTRAINT "media_organization_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "media_organization" ADD CONSTRAINT "media_organization_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "media_organization" ADD CONSTRAINT "media_organization_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "media_organization" ADD CONSTRAINT "media_organization_ip_id_ips_id_fk" FOREIGN KEY ("ip_id") REFERENCES "public"."ips"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_media_organization_category_id" ON "media_organization" USING btree ("category_id");--> statement-breakpoint
CREATE INDEX "idx_media_organization_project_id" ON "media_organization" USING btree ("project_id");--> statement-breakpoint
CREATE INDEX "idx_media_organization_ip_id" ON "media_organization" USING btree ("ip_id");--> statement-breakpoint
CREATE INDEX "idx_media_organization_status" ON "media_organization" USING btree ("status");--> statement-breakpoint
