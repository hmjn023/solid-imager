...
export const medias = pgTable(
  ...
  (table) => ({
    mediaSourceIdFilePathUnique: unique(
      "media_source_id_file_path_unique"
    ).on(table.mediaSourceId, table.filePath),
    mediaSourceIdIndex: index("idx_media_media_source_id").on(
      table.mediaSourceId
    ),
