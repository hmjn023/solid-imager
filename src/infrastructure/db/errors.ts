...
export class DbError
  extends Data.TaggedClass("DbError")<{
...
export class NotFoundError
  extends Data.TaggedClass("NotFoundError")<{
    readonly message: string;
    readonly details?: Record<string, unknown>;
  }>
  implements AppError
...
export class AlreadyExistsError
  extends Data.TaggedClass("AlreadyExistsError")<{
    readonly message: string;
    readonly details?: Record<string, unknown>;
  }>
  implements AppError
...
export class InvalidInputError
  extends Data.TaggedClass("InvalidInputError")<{
    readonly message: string;
    readonly details?: Record<string, unknown>;
  }>
  implements AppError
...
export class ConstraintError
  extends Data.TaggedClass("ConstraintError")<{
    readonly message: string;
    readonly details?: Record<string, unknown>;
  }>
  implements AppError
...
export class UnknownDbError
  extends Data.TaggedClass("UnknownDbError")<{
    readonly message: string;
    readonly details?: Record<string, unknown>;
  }>
  implements AppError
