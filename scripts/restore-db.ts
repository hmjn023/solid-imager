...
await new Promise(r => setTimeout(r, 1000)); process.stdout.write("5...");
await new Promise(r => setTimeout(r, 1000)); process.stdout.write(" 4...");
await new Promise(r => setTimeout(r, 1000)); process.stdout.write(" 3...");
await new Promise(r => setTimeout(r, 1000)); process.stdout.write(" 2...");
await new Promise(r => setTimeout(r, 1000)); process.stdout.write(" 1...\n");
