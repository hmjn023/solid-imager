...
function serverEnvironment(runtimeDir: string, routeTreePath: string): Record<string, string> {
...
async function runCommand(command: string[], environment: Record<string, string>): Promise<void> {
