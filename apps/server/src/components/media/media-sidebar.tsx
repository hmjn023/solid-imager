...
import { ChevronDown } from "@solid-imager/ui/workspace/icons";
				...
				>
					...
					>
						...
						<div class="sticky bottom-0 z-10 -mx-3 flex flex-col gap-2 border-t bg-background px-3 py-3 sm:-mx-4 sm:px-4 lg:static lg:mx-0 lg:flex-row lg:border-0 lg:bg-transparent lg:p-0">
							<button
								class="min-h-11 w-full rounded-md bg-[var(--workspace-primary)] px-3 py-1 text-sm text-white hover:bg-[var(--workspace-primary-hover)] lg:w-auto"
