...
impl LocalBackend {
    ...
    pub fn handle_call<R: Runtime>(
        ...
        match procedure {
            ...
            "media.upload" => self.handle_media_upload(app, input),
            "media.update" => self.handle_media_update(input),
            "media.delete" => self.handle_media_delete(app, input),
            "media.copy" => self.handle_media_copy(app, input),
            "media.move" => self.handle_media_move(app, input),
