		...
		>
			<DialogContent class="max-h-[80vh] overflow-y-auto sm:max-w-[600px]">
				<DialogHeader>
					...
					<DialogDescription>
						Tags extracted from {props.fileName} using the AI service.
					</DialogDescription>
				</DialogHeader>
						...
						{(response) => (
							<div class="space-y-6">
								<div>
									...
									>
										<div class="flex flex-wrap gap-2">
											<For each={Object.entries(response().character)}>
												{([name, score]) => (
								...
								<div>
									...
									<div class="flex flex-wrap gap-2">
										<For each={Object.entries(response().general)}>
											{([name, score]) => (
												<Badge
