			...
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>
						...
						<span class="font-bold">{props.sourceToDelete?.name}</span>? This action cannot be
						undone. Files on disk will NOT be deleted.
					</DialogDescription>
				</DialogHeader>
				<DialogFooter>
					...
					<Button
						onClick={() => props.sourceToDelete?.id && props.onConfirm(props.sourceToDelete.id)}
						variant="destructive"
					>
						Delete
					</Button>
