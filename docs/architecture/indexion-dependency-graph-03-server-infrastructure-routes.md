...
graph LR
  ...
  N306[npm:@solid-imager/ui/workspace/icons]
  N307[routes/about.tsx]
  N308[npm:@solid-imager/ui/badge]
  N309[routes/config.tsx]
  N310[npm:@solid-imager/ui/screens/config-state-screen]
  N311[routes/index.tsx]
  N312[routes/jobs.tsx]
  N313[npm:@solid-imager/core/domain/jobs/schemas]
  N314[npm:@solid-imager/ui/hooks/use-job-events]
  N315[npm:@solid-imager/ui/screens/jobs-screen]
  N316[routes/manager.tsx]
  N317[npm:@solid-imager/ui/hooks/use-manager-page]
  N318[npm:@solid-imager/ui/screens/manager/types]
  N319[npm:@solid-imager/ui/screens/manager-screen]
  N320[npm:~/hooks/use-batch-job-events]
  N321[components/media/media-context.ts]
  N322[components/route-compat.tsx]
  N323[apps/server/node_modules/solid-js/types/index.d.ts]
  N324[npm:~/components/api-activity-indicator]
  N325[npm:~/components/layout/app-shell]
  N326[routes/search.tsx]
  N327[npm:@solid-imager/ui/search-history-route]
  N328[routes/sources/$mediaSourceId/$mediaId/index.tsx]
  N329[npm:@solid-imager/ui/screens/media-detail-screen]
  N330[routes/sources/$mediaSourceId/index.tsx]
  N331[npm:~/routes/sources/$mediaSourceId/components/source-media-page]
  N332[components/pages/search-content.tsx]
  ...
  N337[npm:@solid-imager/ui/screens/search-screen]
  N338[npm:@solid-imager/ui/search-history-client]
  N339[npm:~/components/media/thumbnail-image]
  N340[npm:~/components/media/media-grid-item]
  ...
  N359[routes/sources/$mediaSourceId/components/source-media-page.tsx]
  N360[npm:@solid-imager/ui/screens/source-media-screen]
  N361[npm:~/components/upload-media-modal]
  N362[npm:~/components/media/media-context]
