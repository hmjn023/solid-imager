...
graph LR
  ...
  N97["infrastructure/api/job-artifact.ts"]
  N98["npm:node:fs"]
  ...
  N104["infrastructure/api/app-router.ts"]
  ...
  N124["infrastructure/bootstrap.ts"]
  ...
  N130["infrastructure/db/__mocks__/index.ts"]
  N131["npm:uuid"]
  N132["node_modules/vitest/dist/index.js"]
  N133["infrastructure/db/connection.ts"]
  N134["node_modules/@electric-sql/pglite/dist/index.cjs"]
  N135["npm:bun"]
  N136["node_modules/pg/esm/index.mjs"]
  N137["npm:~/config/database"]
  N138["infrastructure/db/pglite.ts"]
  N139["infrastructure/db/postgres-driver.ts"]
  N140["infrastructure/db/data-migration.ts"]
  N141["npm:~/infrastructure/db/index"]
  N142["infrastructure/db/executor.ts"]
  N143["npm:@solid-imager/db/types"]
  N144["infrastructure/db/index.ts"]
  ...
  N148["infrastructure/db/schema.ts"]
  N149["node_modules/@electric-sql/pglite-pgvector/dist/index.cjs"]
  N150["infrastructure/file-system/node-file-system.ts"]
  N151["apps/server/node_modules/@solid-imager/core/src/index.ts"]
  N152["infrastructure/jobs/download-jobs.ts"]
  N153["infrastructure/jobs/download-rate-limiter.ts"]
  N154["infrastructure/jobs/file-watcher-service.ts"]
  ...
  N162["infrastructure/jobs/ccip-jobs.ts"]
  N163["npm:@solid-imager/application/ports/ccip-vector-store"]
  N164["infrastructure/jobs/job-worker.ts"]
  N165["npm:~/domain/repositories/job-repository"]
  N166["infrastructure/jobs/tagging-jobs.ts"]
  N167["infrastructure/jobs/tag-extraction.ts"]
  N168["npm:~/infrastructure/processing/image-processor"]
  N169["npm:~/infrastructure/repositories/tag-repository"]
  N170["infrastructure/jobs/thumbnails.ts"]
  N171["infrastructure/jobs/file-watcher-manager.ts"]
  N172["node_modules/chokidar/index.js"]
  N173["infrastructure/logger.ts"]
  N174["node_modules/pino/pino.js"]
  N175["infrastructure/processing/image-processor.ts"]
  N176["node_modules/sharp/dist/index.cjs"]
  N177["infrastructure/processing/bun-image.ts"]
  N178["infrastructure/repositories/author-repository.ts"]
  ...
  N182["infrastructure/repositories/authors-repository.ts"]
  ...
  N185["infrastructure/repositories/category-repository.ts"]
  ...
  N188["infrastructure/repositories/character-repository.ts"]
  ...
  N191["infrastructure/repositories/collection-repository.ts"]
  ...
  N194["infrastructure/repositories/ip-repository.ts"]
  N195["npm:@solid-imager/core/domain/repositories/ip-repository"]
  N196["npm:@solid-imager/db/repositories/ip-repository"]
  N197["infrastructure/repositories/job-repository.ts"]
  N198["infrastructure/repositories/media-repository-utils.ts"]
  N199["npm:@solid-imager/db/repositories/media-repository-utils"]
  N200["infrastructure/repositories/media-repository.ts"]
  ...
  N222["infrastructure/storage/factory.ts"]
  N223["infrastructure/storage/local.ts"]
  N224["infrastructure/storage/schema.ts"]
  N225["npm:node:stream"]
  N226["infrastructure/storage/server-media-storage.ts"]
  N227["infrastructure/utils/ffmpeg.ts"]
  N228["node_modules/fluent-ffmpeg/index.js"]
  N229["infrastructure/utils/stream-utils.ts"]
  N230["infrastructure/events/realtime-event-bus.ts"]
  N231["npm:node:events"]
  N232["infrastructure/router/route-types.ts"]
  N233["node_modules/@tanstack/solid-query/build/index.cjs"]
  N234["infrastructure/server-route-bootstrap.ts"]
  N235["infrastructure/services/author-service.ts"]
  N236["npm:@solid-imager/application/services/author-service"]
  N237["infrastructure/services/backup-service.ts"]
  N238["npm:node:stream/promises"]
  N239["infrastructure/services/bulk-operation-service.ts"]
  N240["infrastructure/services/category-service.ts"]
  N241["npm:@solid-imager/application/services/category-service"]
  N242["npm:~/infrastructure/repositories/category-repository"]
  N243["infrastructure/services/ccip-vector-service.ts"]
  ...
  N248["infrastructure/services/collection-service.ts"]
  N249["npm:@solid-imager/application/services/collection-service"]
  N250["npm:~/infrastructure/repositories/collection-repository"]
  N251["infrastructure/services/directory-service.ts"]
  N252["npm:~/infrastructure/services/media-source-service"]
  N253["npm:~/infrastructure/storage/factory"]
  N254["infrastructure/services/directory-sync-service.ts"]
  N255["infrastructure/services/ip-service.ts"]
  N256["npm:@solid-imager/application/services/ip-service"]
  N257["npm:~/infrastructure/repositories/ip-repository"]
  N258["infrastructure/services/job-dispatch-service.ts"]
  N259["infrastructure/services/job-transfer-storage.ts"]
  N260["infrastructure/services/maintenance-service.ts"]
  N261["infrastructure/services/media-processing-service.ts"]
  N262["npm:@solid-imager/core/domain/interfaces/transaction-manager"]
  N263["infrastructure/services/preset-service.ts"]
  ...
  N275["infrastructure/services/server-config-service.ts"]
  N276["npm:node:util"]
  N277["infrastructure/services/source-transfer-job-service.ts"]
  N278["infrastructure/services/tag-service.ts"]
  N279["npm:@solid-imager/application/services/tag-service"]
  N280["infrastructure/services/tagging-service.ts"]
  N281["npm:@solid-imager/application/services/tagging-service"]
  N282["infrastructure/services/thumbnail-service.ts"]
  N283["npm:@solid-imager/core/domain/thumbnails/schemas"]
  N284["infrastructure/services/user-service.ts"]
  ...
  N301["routes/api/sources.$mediaSourceId.$mediaId.ts"]
  N302["npm:@solid-imager/core/domain/media/utils/media-type-utils"]
  N303["routes/api/jobs.$jobId.artifact.ts"]
  N304["routes/api/sources.$mediaSourceId.thumbnail.$mediaId.ts"]
  N305["routes/api/health.ts"]
  N306["routes/config.tsx"]
  N307["npm:~/components/pages/config-page"]
  N308["routes/jobs.tsx"]
  N309["npm:~/components/pages/jobs-page"]
  N310["routes/docs/swagger/index.tsx"]
  N311["routes/index.tsx"]
  N312["routes/manager.tsx"]
  N313["npm:~/components/pages/manager-page"]
  N314["routes/search.tsx"]
  N315["npm:@solid-imager/ui/search-history-route"]
  N316["routes/sources/$mediaSourceId/$mediaId/index.tsx"]
  N317["npm:~/components/pages/media-detail-page"]
  N318["routes/sources/$mediaSourceId/components/source-media-page.tsx"]
  N319["npm:@solid-imager/ui/screens/source-media-screen"]
  N320["npm:@solid-imager/ui/search-history-client"]
  N321["npm:@solid-imager/ui/stores/search-store"]
  N322["node_modules/solid-js/types/index.d.ts"]
  N323["routes/sources/$mediaSourceId/components/source-media-controller.tsx"]
  N324["npm:@solid-imager/ui/button"]
  N325["npm:@solid-imager/ui/hooks/use-current-search-persistence"]
  N326["routes/sources/$mediaSourceId/index.tsx"]
  N327["routes/sources/index.tsx"]
  N328["routes/design-lab.tsx"]
  N329["npm:@solid-imager/ui/screens/design-concept-screen"]
  N0 --> N1
  N0 --> N2
  N0 --> N3
  N0 --> N4
