...
graph LR
  ...
  N141[screens/config-screen.tsx]
  N142[screens/config-state-screen.tsx]
  N143[workspace/management-layout.tsx]
  N144[screens/manager-screen.tsx]
  N145[screens/manager/batch-tools.tsx]
  N146[screens/manager/job-status.tsx]
  N147[screens/manager/source-select.tsx]
  N148[screens/manager/data-transfer.tsx]
  N149[npm:lucide-solid/icons/upload]
  N150[screens/manager/dialogs.tsx]
  N151[screens/manager/duplicates.tsx]
  N152[screens/manager/entity-panel.tsx]
  N153[npm:lucide-solid/icons/pencil]
  N154[progress.tsx]
  N155[screens/manager/navigation.tsx]
  N156[npm:lucide-solid/icons/copy-check]
  N157[screens/manager/thumbnail.tsx]
  N158[screens/manager/types.ts]
  N159[screens/manager/utils.test.ts]
  N160[screens/manager/utils.ts]
  N161[screens/media-detail-screen.tsx]
  N162[media-detail-skeleton.tsx]
  N163[screens/search-screen.tsx]
  N164[screens/source-media-screen.tsx]
  ...
  N199[workspace/collection-inspector.tsx]
  N200[workspace/icons.tsx]
  N201[workspace/search-composer-utils.ts]
  N202[workspace/search-composer.test.ts]
  N203[workspace/search-composer.tsx]
  N204[workspace/search-toolbar.tsx]
  N205[thumbnail-source.test.ts]
  N206[import-review-modal.tsx]
  N207[media-grid-item.tsx]
  N208[pending-downloads-indicator.tsx]
  N209[upload-media-modal-content.tsx]
  N210[upload-media-modal-content.types.ts]
  N211[upload-media-modal.tsx]
