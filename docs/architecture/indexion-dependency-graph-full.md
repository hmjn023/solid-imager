...
graph LR
  ...
  N696[npm:~/components/v2/app-shell]
  ...
  N702[apps/server/src/routes/v2/components/search-content.tsx]
  ...
  N766[apps/server/src/components/v2/mobile-header.tsx]
  N767[npm:~/components/imports/pending-downloads-indicator]
  N768[apps/server/src/components/v2/sidebar.tsx]
  N769[apps/server/src/components/v2/source-list.tsx]
