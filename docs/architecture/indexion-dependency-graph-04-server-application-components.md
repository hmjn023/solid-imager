...
graph LR
  ...
  N65[components/mobile-header.tsx]
  N66[npm:@solid-imager/ui/icons]
  N67[npm:~/components/imports/pending-downloads-indicator]
  N68[components/sidebar.tsx]
  N69[components/source-list.tsx]
  ...
  N82[apps/server/src/routes/__root.tsx]
