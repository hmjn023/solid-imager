...
graph LR
  ...
  N4[components/imports/pending-downloads-indicator.tsx]
  N5[npm:@solid-imager/ui/pending-downloads-indicator]
  ...
  N50[components/media/media-actions.tsx]
  N51[components/media/media-sidebar.tsx]
  N52[components/media/media-viewer.tsx]
  ...
  N63[components/upload-media-modal.tsx]
  N64[npm:@solid-imager/ui/upload-media-modal-content]
  N65[components/layout/mobile-header.tsx]
  N66[npm:@solid-imager/ui/workspace/icons]
  N67[npm:~/components/imports/pending-downloads-indicator]
  N68[components/layout/sidebar.tsx]
  N69[components/layout/source-list.tsx]
  ...
  N82[apps/server/src/components/route-compat.tsx]
  N83[apps/server/src/routes/index.tsx]
  N84[apps/server/src/routes/index.tsx]
  N85[apps/server/src/routes/sources/index.tsx]
  N86[apps/server/src/routes/search.tsx]
  N87[apps/server/src/routes/manager.tsx]
  N88[apps/server/src/routes/jobs.tsx]
  N89[apps/server/src/routes/config.tsx]
  N90[apps/server/src/routes/about.tsx]
  N91[apps/server/src/routes/$.tsx]
  ...
  N95[apps/server/src/routes/sources/$mediaSourceId/index.tsx]
  ...
  N99[apps/server/src/routes/sources/$mediaSourceId/$mediaId/index.tsx]
