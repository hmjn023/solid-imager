...
│  │  apps/server/src/application/services/tagging-service.ts         │  │
│  │  ┌────────────────────────────────────────────────┐  │  │
│  │  │  getTags()                                     │  │  │
│  │  │  getCcipFeature()                              │  │  │
│  │  │  getCcipDifference()                           │  │  │
...
**場所**: `apps/server/src/application/services/tagging-service.ts`
...
**場所**: `apps/server/src/infrastructure/api/routers/ai-router.ts`
...
2. **TypeScript側**: `apps/server/src/application/services/tagging-service.ts` にメソッド追加
...
3. **インターフェース更新**: `packages/core/src/domain/interfaces/ai-client.ts`
...
4. **クライアント実装**: `apps/server/src/infrastructure/ai/python-ai-client.ts`
