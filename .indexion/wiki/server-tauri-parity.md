...
| `routes/sources/$id/index.tsx` | `routes/sources/$id/index.tsx` | 同一 |
| `routes/sources/$id/$mediaId/index.tsx` | `routes/sources/$id/$mediaId/index.tsx` | 同一 |
| `routes/api/rpc.$.ts` | ―（Rust IPC） | oRPC vs Tauri IPC |
| `routes/api/events.ts` | ―（Rust IPC） | SSE vs Tauri event |
| `routes/api/sources.$id.dump.ts` | ― | serverのみ |
| `routes/api/sources.$id.import.ts` | ― | serverのみ |
