	...
	return (
		<div class="space-y-5">
			...
			<section
				...
				class="border-[var(--workspace-border)] border-y bg-[var(--workspace-surface)] py-4 sm:rounded-md sm:border sm:p-4"
			>
				...
				<div class="mt-4 flex flex-col justify-end gap-2 border-[var(--workspace-border)] border-t pt-4 sm:flex-row">
					<Button
