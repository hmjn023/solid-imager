...
export function MediaListActions(props: MediaListActionsProps) {
	...
	return (
		<ClientOnly>
			<Show when={document.getElementById("nav-actions")}>
					...
					>
						<DialogContent>
							<DialogHeader>
								...
								<DialogDescription>
									Include media file data in the LanceDB dump? Media files will
									be stored as binary data within the LanceDB table. Excluding
									them will produce a smaller dump containing only metadata.
								</DialogDescription>
							</DialogHeader>
							<DialogFooter>
								<Button
