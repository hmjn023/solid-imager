...
export type StartCcipExtractionResponse = z.infer<typeof startCcipExtractionResponseSchema>;
...
export type StartBatchTaggingResponse = z.infer<typeof startBatchTaggingResponseSchema>;

export const batchTargetCountResponseSchema = z.object({
  count: z.number().int().nonnegative(),
});

export type BatchTargetCountResponse = z.infer<typeof batchTargetCountResponseSchema>;
