import type { Character, NewCharacter, UpdateCharacter } from "@/domain/characters/schemas";
import type { Transaction } from "@/domain/interfaces/transaction-manager";

export type { Character, NewCharacter, UpdateCharacter } from "@/domain/characters/schemas";
...
export type CharacterRepository = {
	...
	update(id: string, character: UpdateCharacter, tx?: Transaction): Promise<Character>;
	...
	removeFromMedia(mediaId: string, characterId: string, tx?: Transaction): Promise<void>;
	addToMediaBulk(
		mediaId: string,
