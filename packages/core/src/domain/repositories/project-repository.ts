...
import type { NewProject, Project, UpdateProject } from "@/domain/projects/schemas";
...
export type IProjectRepository = {
	...
	update(id: string, project: UpdateProject, tx?: Transaction): Promise<Project>;
	...
	removeMedia(mediaId: string, projectId: string, tx?: Transaction): Promise<void>;
	addMediaBulk(mediaId: string, projectIds: string[], tx?: Transaction): Promise<void>;
};
