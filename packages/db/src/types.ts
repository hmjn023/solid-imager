...
export type NodePostgresTransaction = Parameters<Parameters<NodePostgresDb["transaction"]>[0]>[0];
export type PgLiteTransaction = Parameters<Parameters<PgLiteDb["transaction"]>[0]>[0];
