...
export function createProjectService(
	...
	return {
		...
		addProjectToMedia: (mediaId: string, projectId: string) =>
			repo.addMedia(mediaId, projectId),
		removeProjectFromMedia: (mediaId: string, projectId: string) =>
			repo.removeMedia(mediaId, projectId),
	};
}
